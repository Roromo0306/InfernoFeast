...
public class CanvasCajas : MonoBehaviour
{
    ...
    public void IntanciarIngrediente(List<TipoIngrediente> TipoIngrediente)
    {
        ...
        Instantiate(tipos[indice].prefabIngrediente, EspacioInstanciado.position, tipos[indice].prefabIngrediente.transform.rotation, EspacioInstanciado); //Se Instancia los ingredientes
